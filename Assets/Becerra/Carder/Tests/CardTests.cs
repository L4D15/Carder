 ...
 namespace Becerra.Carder.Tests
 {
     public class Parser
     {
        ...
        public void ActionTitle()
        {
            ...
            Assert.AreEqual(5, titleSection.Costs.Length);
            Assert.AreEqual(ActionCostType.OneAction, titleSection.Costs[0]);
            Assert.AreEqual(ActionCostType.TwoActions, titleSection.Costs[1]);
            Assert.AreEqual(ActionCostType.ThreeActions, titleSection.Costs[2]);
            Assert.AreEqual(ActionCostType.Reaction, titleSection.Costs[3]);
            Assert.AreEqual(ActionCostType.Free, titleSection.Costs[4]);
        }
